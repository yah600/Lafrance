...
// @ts-ignore
interface DialogButtonProps extends Omit<React.ComponentProps<'button'>, keyof Props>, Props {
  ref?: React.Ref<HTMLElement>;
}

declare const DialogButton: React.ComponentType<DialogButtonProps>;
